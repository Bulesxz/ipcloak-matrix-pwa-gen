...
export const dict = {
  zh: {
    ...
    screenshots: '截图',
    // -- site (home) --
    siteTitle: 'ipcloak.ai · W2A 安装页生成器 (PWA + APK) + 像素跟踪',
    siteHero: 'W2A 一键生成<br/>把网站变成可安装的 App',
    siteSub: '一站式 PWA + APK 安装页生成 · 支持 Facebook / TikTok / Kwai 像素跟踪 · 投流圈最常用的 W2A 工具',
    siteCTA: '立即生成',
    siteScanning: '扫描中...',
    siteFeature1: '即时预览',
    siteFeature2: '智能提取',
  ...
  en: {
    ...
    // -- site (home) --
    siteTitle: 'ipcloak.ai · W2A Generator (PWA + APK) + Pixel Tracking',
    siteHero: 'W2A — One-Click<br/>Turn websites into Apps',
    siteSub: 'All-in-one PWA + APK installer pages · Facebook / TikTok / Kwai pixel tracking · The go-to W2A tool for performance marketers',
