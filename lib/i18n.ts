...
export const dict = {
  zh: {
    ...
    screenshots: '截图',
    // -- site (home) --
    siteTitle: 'ipcloak.ai · PWA 安装页生成器 (W2A) + APK + 像素跟踪',
    siteHero: 'PWA 安装页生成器<br/>把网站变成可安装的 App',
    siteSub: '输入 URL 秒级生成 PWA 安装页 + APK 下载页 · 内置 Facebook / TikTok / Kwai 像素跟踪 · 投流圈称之为 W2A',
    siteCTA: '立即生成',
    siteScanning: '扫描中...',
    siteFeature1: '即时预览',
    siteFeature2: '智能提取',
  ...
  en: {
    ...
    // -- site (home) --
    siteTitle: 'ipcloak.ai · PWA Installer Generator (W2A) + APK + Pixel Tracking',
    siteHero: 'PWA Installer Generator<br/>Turn websites into installable Apps',
    siteSub: 'Generate PWA install pages + APK download pages from any URL in seconds · Built-in Facebook / TikTok / Kwai pixel tracking · Known as W2A in the performance marketing space',
