...
const PRODUCTS: MatrixProduct[] = [
  ...
  },
  {
    ...
    emoji: '📲',
    desc: '本工具 · PWA 产品详情',
    href: 'https://ipcloak.ai/services/pwa/',
    current: true,
  },
  {
    name: 'IPLink 短链',
  ...
  {
    name: 'IPBuilder 落地页搭建',
    emoji: '🧱',
    desc: '可视化拖拽 · AI 一键生成',
    href: 'https://ipcloak.ai/services/landing-page/',
  },
  {
    name: 'IPLanding 落地页代做',
    emoji: '🎨',
    desc: '海量模板 · 24h 定制',
  ...
  },
  {
    ...
    emoji: '🛠️',
    desc: 'IP 查询检测',
    href: 'https://ipcloak.ai/services/ip-tool/',
  },
];
